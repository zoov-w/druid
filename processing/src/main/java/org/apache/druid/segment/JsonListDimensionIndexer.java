...
public class JsonListDimensionIndexer implements DimensionIndexer<Integer, int[], String>
{
    ...
    public JsonListDimensionIndexer(DimensionSchema.MultiValueHandling multiValueHandling, boolean hasBitmapIndexes)
    {
        ...
        if (dimValues == null) {
            ...
            if (dimValuesList.isEmpty()) {
                ...
                for (String dimensionValue : dimensionValues) {
                    if (multiValueHandling != DimensionSchema.MultiValueHandling.SORTED_SET) {
